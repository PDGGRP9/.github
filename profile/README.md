...
- Transmission périodique et fiable des mesures vers l'application Android.
- Visualisation des données et de l’historique sur l'application Android ainsi que sur l'application web.
